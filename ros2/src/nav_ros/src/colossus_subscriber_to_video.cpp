...
void Colossus_subscriber_to_video::configuration_data_callback(const messages::msg::ConfigurationDataMessage::SharedPtr msg) const
{
...
void Colossus_subscriber_to_video::fft_data_callback(const messages::msg::FftDataMessage::SharedPtr msg) const
{
    if (!node->config_data_received) {
